...
class StaticBallmachinePasscodeResolver : BallmachinePasscodeResolver {
  ...
  override fun getPasscode(dayOfWeek: DayOfWeek, slot: Slot): BallmachinePassCode {
    return when {
      (dayOfWeek == DayOfWeek.MONDAY && slot.index >= 36) -> BallmachinePassCode("72380")
      (dayOfWeek == DayOfWeek.MONDAY && slot.index >= 24) -> BallmachinePassCode("22510")
      (dayOfWeek == DayOfWeek.MONDAY && slot.index >= 12) -> BallmachinePassCode("30607")
      (dayOfWeek == DayOfWeek.TUESDAY && slot.index >= 36) -> BallmachinePassCode("11771")
      (dayOfWeek == DayOfWeek.TUESDAY && slot.index >= 24) -> BallmachinePassCode("98077")
      (dayOfWeek == DayOfWeek.TUESDAY && slot.index >= 12) -> BallmachinePassCode("77306")
      (dayOfWeek == DayOfWeek.WEDNESDAY && slot.index >= 36) -> BallmachinePassCode("82414")
      (dayOfWeek == DayOfWeek.WEDNESDAY && slot.index >= 24) -> BallmachinePassCode("44213")
      (dayOfWeek == DayOfWeek.WEDNESDAY && slot.index >= 12) -> BallmachinePassCode("86508")
      (dayOfWeek == DayOfWeek.THURSDAY && slot.index >= 36) -> BallmachinePassCode("19162")
      (dayOfWeek == DayOfWeek.THURSDAY && slot.index >= 24) -> BallmachinePassCode("31857")
      (dayOfWeek == DayOfWeek.THURSDAY && slot.index >= 12) -> BallmachinePassCode("34581")
      (dayOfWeek == DayOfWeek.FRIDAY && slot.index >= 36) -> BallmachinePassCode("42615")
      (dayOfWeek == DayOfWeek.FRIDAY && slot.index >= 24) -> BallmachinePassCode("84536")
      (dayOfWeek == DayOfWeek.FRIDAY && slot.index >= 12) -> BallmachinePassCode("42986")
      (dayOfWeek == DayOfWeek.SATURDAY && slot.index >= 36) -> BallmachinePassCode("37569")
      (dayOfWeek == DayOfWeek.SATURDAY && slot.index >= 24) -> BallmachinePassCode("26283")
      (dayOfWeek == DayOfWeek.SATURDAY && slot.index >= 12) -> BallmachinePassCode("92896")
      (dayOfWeek == DayOfWeek.SUNDAY && slot.index >= 36) -> BallmachinePassCode("77825")
      (dayOfWeek == DayOfWeek.SUNDAY && slot.index >= 24) -> BallmachinePassCode("96146")
      (dayOfWeek == DayOfWeek.SUNDAY && slot.index >= 12) -> BallmachinePassCode("37587")
