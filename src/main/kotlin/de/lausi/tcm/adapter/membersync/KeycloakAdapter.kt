...
private class KeycloakConfiguration {
    ...
    @Bean
    fun keycloakAdapter(keycloakApi: KeycloakApi, properties: KeycloakProperties): KeycloakAdapter =
            KeycloakAdapterImpl(properties.clientId, properties.clientSecret, keycloakApi)
}
...
private class KeycloakAdapterImpl(
    ...
    override fun getKeycloakUsers(): List<KeycloakUser> {
        ...
        val keycloakUsersResponse = keycloakApi.getKeycloakUsers("Bearer $accessToken").execute()
